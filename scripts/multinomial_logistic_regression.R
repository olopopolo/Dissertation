...
View(dataframe)
dataframe$construction_schema <- as.factor(dataframe$construction_schema)
dataframe$student_DLC <- as.factor(dataframe$student_DLC)
...
fit <- vglm(construction_schema ~ student_DLC, data = dataframe, family=multinomial)
summary(fit)
library(nnet)
model <- multinom(construction_schema ~ student_DLC, data = dataframe, family=multinomial)
summary(model)
library(stargazer)
